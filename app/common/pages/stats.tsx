		...
		<section className="py-12 bg-gray-50 sm:py-16 lg:py-20">
			<div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
				<div className="max-w-2xl mx-auto text-center xl:max-w-4xl">
					<h2 className="text-3xl font-bold text-gray-900 sm:text-4xl xl:text-5xl font-pj">The only
						platform that creates
						unique & rare UI Kits with TailwindCSS</h2>
				</div>
				...
				<div className="relative mt-12 lg:mt-20 lg:max-w-5xl lg:mx-auto">
					...
					<div
						className="relative grid grid-cols-1 px-16 py-12 overflow-hidden text-center bg-white sm:grid-cols-2 gap-y-12 lg:grid-cols-4 rounded-2xl gap-x-20">
