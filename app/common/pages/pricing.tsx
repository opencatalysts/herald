export default function Pricing() {
	return (
		<section className='bg-brand-900 py-12 sm:py-16 lg:py-20'>
			<div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
				<div className='mx-auto max-w-2xl text-center'>
					<h2 className='font-pj text-3xl font-bold text-gray-300 sm:text-4xl xl:text-5xl'>
						Simple, Transparent Pricing
					</h2>
				</div>

				<div className='relative mx-auto mt-8 max-w-6xl md:mt-16'>
						...
						<div className='px-16 py-8 sm:px-8 lg:px-16 lg:py-14'>
							<div className='md:flex md:items-center md:space-x-12 lg:space-x-24'>
								<div className='grid grid-cols-1 gap-y-3 gap-x-12 sm:grid-cols-2 xl:gap-x-24'>
									<div>
										<ul className='font-pj space-y-3 text-base font-medium text-white'>
								...
								<div className='mt-10 md:mt-0'>
									<div className='flex items-end justify-center'>
										<p className='font-pj text-5xl font-bold text-white'>
											$39
										</p>
				...
				<div className='mx-auto mt-12 hidden max-w-2xl text-center sm:mt-16 sm:hidden sm:items-start sm:justify-center sm:text-left'>
					<img
					...
					<div className='mt-6 sm:mt-0 sm:ml-12'>
						...
						<p className='font-pj mt-5 text-base font-bold text-gray-900'>
							Marvin McKinney
						</p>
						<p className='font-pj mt-0.5 text-sm font-normal text-gray-600'>
							Founder, StartBell
						</p>
					</div>
				</div>
